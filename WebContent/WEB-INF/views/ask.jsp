...
<link rel="stylesheet" type="text/css" href="/css/ask.css?ver=1">
	<div class="ask">
		<table class="nes-table is-bordered is-centered" width="1100" height="500">
	<tr>
		<td><div><h1 style="color: #fff; text-align:center;">질문답변</h1></div></td>
	</tr>
		<tr class="askBorder">
			<td colspan=11 class="askBorderLeft">
				<div class="borderTop">자주하는질문</div>
			</td>
			<td class="askBorderRight">
